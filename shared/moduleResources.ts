...
export const MAX_MODULE_RESOURCE_PDF_BYTES = 200 * 1024 * 1024;
export const MODULE_RESOURCE_PROXY_UPLOAD_MAX_BYTES = 20 * 1024 * 1024;
export const MODULE_RESOURCE_MULTIPART_THRESHOLD_BYTES = 100 * 1024 * 1024;
export const MODULE_RESOURCE_MULTIPART_PART_SIZE_BYTES = 16 * 1024 * 1024;
export const MAX_MODULE_RESOURCE_PART_UPLOAD_CONCURRENCY = 3;
export const MODULE_RESOURCE_UPLOAD_EXPIRY_SECONDS = 60 * 60;
