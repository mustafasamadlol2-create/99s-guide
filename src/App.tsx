...
const ProfileCompletionScreen = lazyWithPreload(() => import("./features/auth/components/ProfileCompletionScreen"));
...
// Kick off critical route preloads immediately on bundle execution so they are 
// ready by the time the splash screen finishes and auth-check completes.
AuthScreen.preload();
...
const AppleEmailSelectionScreen = lazyWithPreload(() => import("./features/auth/components/AppleEmailSelectionScreen").then(m => ({ default: m.AppleEmailSelectionScreen })));
