...
const ARABIC_UI_TEXT: Record<string, string> = {
  "99's Guide": "دليل 99",
  "Welcome to 99's Guide": "مرحبًا بك في دليل 99",
  "Sign in with your Baghdad University College of Medicine account to access the Medical Portal.": "سجّل الدخول باستخدام حساب كلية الطب بجامعة بغداد للوصول إلى البوابة الطبية.",
  "Create Account": "إنشاء حساب",
  "Join the collaborative medical study network": "انضم إلى شبكة الدراسة الطبية التعاونية",
  "Reset Password": "إعادة تعيين كلمة المرور",
  "Provide your registered university email": "أدخل بريدك الجامعي المسجل",
  "Check Your Inbox": "تحقق من بريدك الوارد",
  "Secure recovery link dispatched": "تم إرسال رابط استعادة آمن",
  "Personal Information": "المعلومات الشخصية",
  "Tell us a little about yourself": "أخبرنا قليلًا عنك",
  "University Information": "المعلومات الجامعية",
  "Connect your academic identity": "اربط هويتك الأكاديمية",
  "Password": "كلمة المرور",
  "Secure your student account": "أمّن حسابك الطلابي",
  "Review": "المراجعة",
  "Make sure everything is correct": "تأكد من صحة جميع المعلومات",
  "Verify Your Email": "تحقق من بريدك الإلكتروني",
  "Success": "تم بنجاح",
  "Confirm your university inbox to continue": "أكد بريدك الجامعي للمتابعة",
  "Your student account is ready": "حسابك الطلابي جاهز",
  ...
  "Approved": "مقبول",
  "Rejected": "مرفوض",
  "Blocked on": "تم الحظر في",
  "Submitted on": "تم الإرسال في",
  "Failed to load reports. Please try again.": "تعذر تحميل البلاغات. يرجى المحاولة مرة أخرى.",
