...
const translations = {
  en: {
    ...
    calendarImportHelp:
      "Upload a schedule PDF. Nothing is added until you review and confirm.",
    calendarImportChoose: "Choose PDF",
  ...
  ar: {
    ...
    calendarImportHelp:
      "ارفع ملف PDF للجدول. لن تتم إضافة أي فعالية قبل مراجعتك وتأكيدك.",
    calendarImportChoose: "اختر ملف PDF",
