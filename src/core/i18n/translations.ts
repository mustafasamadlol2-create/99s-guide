...
const translations = {
  en: {
    ...
    calendarImportHelp:
      "Upload a PDF/image or paste schedule text. Nothing is added until you review and confirm.",
    calendarImportChoose: "Choose PDF or image",
    calendarImportFiles: "PDF / Images",
    calendarImportText: "Paste text",
    calendarImportTextPlaceholder: "Paste the complete schedule text here…",
  ...
  ar: {
    ...
    calendarImportHelp:
      "ارفع ملف PDF أو صورًا للجدول أو الصق النص مباشرة. لن تتم إضافة أي فعالية قبل مراجعتك وتأكيدك.",
    calendarImportChoose: "اختر PDF أو صورة",
    calendarImportFiles: "PDF / صور",
    calendarImportText: "لصق نص",
    calendarImportTextPlaceholder: "الصق نص الجدول كاملًا هنا…",
