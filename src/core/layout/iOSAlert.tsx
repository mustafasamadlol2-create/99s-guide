...
export default function IOSAlert() {
 ...
 className="relative w-full max-w-[270px] bg-neutral-100/90 dark:bg-[#1C1C1E]/90 backdrop-blur-overlay rounded-md overflow-hidden shadow-elevation-3 border border-neutral-200/40 dark:border-white/[0.05] flex flex-col text-center"
 >
 {/* Title & Message Panel */}
