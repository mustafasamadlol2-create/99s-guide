...
export default function AuthBackground() {
  ...
  return (
    ...
    >
      ...
      {/* ── 2. Stylized "99" Outline Background ──────────────────────────
          Oversized, rotated, stroke-only digits.
          Partially cropped from both edges with large negative space.
          Static — composited without repaint.
      ──────────────────────────────────────────────────────────────────── */}

      <div
        className="absolute top-1/2 left-1/2 flex items-center justify-between pointer-events-none text-neutral-900 dark:text-white"
        style={{
          width:      "140%",
          transform:  "translate(-50%, -50%) rotate(12deg)",
          opacity:    0.045, // Extremely subtle (4.5%)
          filter:     "blur(1.5px)",
          zIndex:     1, // Right above mesh gradient
        }}
      >
        <svg
          viewBox="15 5 70 120"
          ...
          style={{ width: "35%", height: "auto", maxWidth: "450px" }}
        >
          {/* A smooth geometric '9' */}
          <path vectorEffect="non-scaling-stroke" d="M 80 40 A 30 30 0 1 0 50 70 A 30 30 0 0 0 80 40 V 85 C 80 115 60 125 35 120" />
        </svg>
      ...
      {/* ── 3. Radial spotlight behind card ──────────────────────────────
