...
export function useBulletinSegmentPager({
  ...
  /** Keep the destination page physically adjacent to the foreground page. */
  ...
  const finishSuccessfulTransition = useCallback(
    ...
    [clearHandoffFrames, reduceMotion, stopAnimation, syncAdjacentPage, underlayX, x],
  );
  ...
  const navigateTo = useCallback(
    ...
    [exitSignFor, finishSuccessfulTransition, getSurfaceWidth, isEnabled, syncAdjacentPage, x],
  );
  ...
  return { surfaceRef, x, underlayX, isInteracting, navigateTo };
}
