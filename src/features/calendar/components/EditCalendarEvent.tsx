      ...
      <div className="sticky top-0 z-30 bg-neutral-50/90 dark:bg-[#111113]/90 backdrop-blur-md border-b border-neutral-200/60 dark:border-white/[0.08] flex-shrink-0">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
          <button
            type="button"
            onClick={onBack}
            className="ece-back-btn shrink-0 w-9 h-9 flex items-center justify-center rounded-full bg-neutral-100 dark:bg-white/[0.08] text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-white/[0.14] transition duration-150"
            aria-label="Back"
          >
                ...
                {EVENT_TYPES.map((et) => {
                  ...
                  return (
                    <button
                      ...
                      className={`ece-chip px-4 py-2 rounded-lg text-caption font-semibold border transition duration-150 ${
                        isSelected
