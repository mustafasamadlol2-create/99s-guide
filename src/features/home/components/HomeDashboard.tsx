          ...
          <div className="flex flex-col relative z-10">
            ...
            >
              ...
              >
                ...
                {/* Stable premium message transition for iOS/WKWebView.
                    `wait` guarantees the old line is fully removed before the next one
                    is mounted, so there is no overlapping glyph layer and no post-animation
                    ghosting. The exit stays in place and fades; the new line then glides in. */}
                <div
                    ...
                    <motion.div
                      ...
                      exit={
                        reduceMotion
                          ? { opacity: 0 }
                          : {
                              // Do not translate the outgoing glyphs through the clipping
                              // edge. A pure fade avoids WKWebView's stale glyph raster while
                              // `mode=wait` ensures the incoming layer is not mounted yet.
                              opacity: 0,
                              transition: {
                                duration: 0.22,
                                ease: [0.4, 0, 1, 1],
