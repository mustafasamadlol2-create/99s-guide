...
export default function CreateLecture({
 ...
 {isRtl ? "اسم المحاضرة" : "Presentation title"}
  ...
  <input aria-label={isRtl ? "اسم المحاضرة" : "Presentation title"}
 type="text"
 required
 placeholder={
 isRtl
 ...
 <div className="flex items-center gap-2">
  <input aria-label={isRtl ? "جدولة المحاضرة" : "Schedule lecture"}
 type="checkbox"
 ...
 {isRtl ? "تاريخ إلقاء المحاضرة" : "Scheduled Date"}
  ...
  <input aria-label={isRtl ? "تاريخ الجدولة" : "Scheduled date"}
 type="date"
 value={scheduleDate}
 ...
 {isRtl ? "وقت البدء" : "Start Time"}
  ...
  <input aria-label={isRtl ? "وقت البدء" : "Start time"}
 type="time"
 ...
 {isRtl ? "وقت الانتهاء" : "End Time"}
  ...
  <input aria-label={isRtl ? "وقت الانتهاء" : "End time"}
 type="time"
