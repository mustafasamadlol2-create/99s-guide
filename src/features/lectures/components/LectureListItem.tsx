...
// Highly optimized card contents component positioned inside ContextMenu rendered tree
 ...
 <div className="lecture-list-chips flex items-center gap-2 overflow-x-auto custom-scrollbar pb-1 -mb-1 scrollbar-hide overscroll-x-contain min-w-0 flex-1">
 <motion.button 
  type="button"
  whileTap={{ scale: 0.94 }}
