      ...
      {user && (
        <>
          ...
          <motion.div
            ...
            className="mobile-overlay-top fixed top-0 right-0 bottom-0 z-50 w-full max-w-lg bg-white dark:bg-[#1C1C1E] border-l border-neutral-200 dark:border-white/[0.08] shadow-2xl flex flex-col"
          >
            {/* Header */}
