...
export const MODULE_VISUALS: Record<SubjectId, ModuleVisualIdentity> = {
  ...
  PHC: { credits: 4, hours: 59, image: publicHealthCareImage, placeholder: "data:image/webp;base64,", accent: "#F6C76F", accentRgb: "246,199,111", surfaceClass: "bg-[#FFF9EB] dark:bg-[#282217]" },
...
export function isModuleArtworkReady(src: string): boolean {
  return warmedArtwork.has(src);
}
