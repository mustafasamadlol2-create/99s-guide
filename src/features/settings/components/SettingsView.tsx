...
interface SettingsViewProps {
 ...
 onAccountDeleted?: () => Promise<boolean>;
}
...
const SettingsView = function SettingsView({
 ...
 if (onAccountDeleted) {
 const success = await onAccountDeleted();
 if (success) {
 ...
 <div className="shrink-0 ml-4 flex bg-neutral-100 dark:bg-[#2C2C2E]/80 p-1 rounded-lg text-sm font-medium">
 <button
 onClick={handleThemeLight}
 className={`px-3 py-2 rounded-md transition ${theme === "light" ? "bg-white dark:bg-neutral-700 shadow-elevation-1 text-neutral-900 dark:text-white" : "text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-500 dark:text-[#EBEBF599]"}`}
 >
 {isRtl ? "فاتح" : "Light"}
 </button>
 <button
 onClick={handleThemeDark}
 className={`px-3 py-2 rounded-md transition ${theme === "dark" ? "bg-white dark:bg-neutral-700 shadow-elevation-1 text-neutral-900 dark:text-white" : "text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-500 dark:text-[#EBEBF599]"}`}
 >
 {isRtl ? "داكن" : "Dark"}
 </button>
 <button
 onClick={handleThemeSystem}
 className={`px-3 py-2 rounded-md transition ${theme === "system" ? "bg-white dark:bg-neutral-700 shadow-elevation-1 text-neutral-900 dark:text-white" : "text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-500 dark:text-[#EBEBF599]"}`}
 >
 {isRtl ? "تلقائي" : "Auto"}
 </button>
 </div>
 ...
 className={`px-3 py-2 rounded-md transition ${language === "en" ? "bg-white dark:bg-neutral-700 shadow-elevation-1 text-neutral-900 dark:text-white" : "text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-500 dark:text-[#EBEBF599]"}`}
 >
 English
 </button>
 <button
 onClick={handleLangAr}
 className={`px-3 py-2 rounded-md transition ${language === "ar" ? "bg-white dark:bg-neutral-700 shadow-elevation-1 text-neutral-900 dark:text-white" : "text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-500 dark:text-[#EBEBF599]"}`}
 >
 العربية
 </button>
 </div>
...
/>
 ...
 {isRtl
 ? "هذا الإجراء لا يمكن التراجع عنه. سيتم محو جميع بياناتك الأكاديمية وسجلاتك بشكل دائم. يرجى إدخال كلمة المرور لتأكيد الإجراء."
 : "This action is irreversible. All your academic data, streaks, and calendar events will be permanently erased. Please enter your password to confirm."}
 </p>
 ...
 <button
 type="submit"
 disabled={isDeleting || deleteInput.length < 6}
 ...
 <button
 onClick={closePrivacyModal}
 className="w-full mt-6 py-3 bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 font-medium text-base rounded-lg hover:bg-neutral-800 dark:hover:bg-neutral-100 transition duration-[180ms] ease-out hover:-translate-y-[1px] hover:shadow-elevation-1 dark:hover:shadow-elevation-1 shadow-elevation-1 "
 >
 {isRtl ? "إغلاق" : "Close"}
 </button>
 </motion.div>
