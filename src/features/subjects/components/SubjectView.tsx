...
export const SubjectView = function SubjectView({
  ...
  const getDefaultSubSubject = (subjId: string, isRtl: boolean) => {
    ...
    const items: Record<string, { en: string; ar: string }> = {
      ...
      NT: { en: "Nutrition", ar: "التغذية السريرية" },
      RM: { en: "Research Methodology", ar: "مناهج البحث والتحليل" },
          ...
          <div className="subject-breadcrumbs text-neutral-500 dark:text-[var(--text-secondary)] font-medium text-base mt-2 flex items-center flex-wrap gap-1 -ml-2 antialiased">
            <button
              onClick={() => {
                ...
                // The other six subjects go directly to Theory/Practical/TBL,
